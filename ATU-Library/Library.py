...
class maincode:
    ...
    def login(self):
        ...
        if self.ab is not None:
            ...
            self.lb3 = Label(self.fm2, text='ATU LIBRARY', fg='White', bg='#0f624c', font=('Arial', 30, 'bold'))
            ...
            messagebox.showerror('Your ID or Password is not Valid')
        # ---------------------------------------------------------
    ...
    def cur(self):
        ...
        self.photo9 = PhotoImage(file="bbb.png")
        self.canvas8.create_image(0, 0, image=self.photo9, anchor=NW)

        self.develop = Label(self.fm3, text='Developed By - Group5', bg='#fff', fg='blue',
    ...
    def issuebook(self):
        class test(maincode):
            ...
            def issued(self):
                ...
                comm = dc.cursor()
                comm.execute("UPDATE student SET From_date='" + str(self.x) + "', To_date='" + str(self.date) + "' "
        ...
        class editing(maincode):
            ...
            def search(self):
                ...
                if self.val != None:
                    ...
                    self.edcat = Tk()
                    self.edcat.title("Accra Technical University Library System")
            ...
            def retbook(self):
                ...
                if self.data != None:
                    ...
                    if self.var != None:
                        ...
                        if chm <= 0:
                            self.lc1 = Label(self.tom, text="0 Ghs.", bg="black", fg="#fff", font=('arial', 12,
                                                                                                  'bold'))
    ...
    def code(self):
        ...
        self.photo = PhotoImage(file=r"images/bb.png")
        ...
        self.photo1 = PhotoImage(file=r"images/dd.png")
    ...
    def chan_pas(self):
        ...
        if self.data != None:
            ...
            conn.commit()
            messagebox.showinfo("Your Password is changed successfully!")
        else:
